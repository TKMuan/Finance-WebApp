...
def create_tables(conn: connection, r: str):
    ...
    with connect(
        ...
        try: 
            ...
            if args.r:
                ...
                admin_id = ModelUtil.generate_sha256_hash(str(created) + "admin" + "user")
                hashed_password = ModelUtil.generate_sha256_hash("adminpassword")
                with conn.cursor() as cur:
